# Generated by Django 4.2.6 on 2023-11-17 07:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='od_status',
            field=models.CharField(choices=[('Cancelled', 'Cancelled'), ('Return', 'Return'), ('Shipped', 'Shipped'), ('Processing', 'Processing'), ('Delivered', 'Delivered'), ('Pending', 'Pending')], default='pending', max_length=150, null=True),
        ),
